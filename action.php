			...
			echo "<form method='post' action='checkout.php'>";
				...
				while ($row=mysqli_fetch_array($query)) {
					...
					echo 
						'<div class="row">
								...
								<div class="col-md-2"><input type="text" name="qty[]" class="form-control qty" value="'.$qty.'" ></div>
				...
				echo '<div class="row">
							...
							<div class="col-md-4">
								...
								<button type="submit" style="padding:5px 4px;background-color:#94ff70;margin-right:180px;">Checkout</button>
